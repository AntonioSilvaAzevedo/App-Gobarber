...
const CreateAppointment: React.FC = () => {
  ...
  const handleCreatedAppointment = useCallback(async () => {
    try {
  ...
  const afeternoonAveilability = useMemo(() => {
    return availability
      .filter(({ hour }) => hour >= 12)
      .map(({ hour, available }) => {
        return {
  ...
  return (
    <Container>
      ...
      <Content>
        ...
        <CreateAppointmetButton onPress={handleCreatedAppointment}>
